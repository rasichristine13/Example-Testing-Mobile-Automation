...
Mobile.tap(findTestObject('Object Repository/Facebook/Searching/click search'), 0)

Mobile.setText(findTestObject('Object Repository/Facebook/Searching/input search'), 'christine ', 0)

Mobile.tap(findTestObject('Object Repository/Facebook/Searching/click search result'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/Facebook/Searching/verify element exist'), 0)

Mobile.takeScreenshot('/Users/macbook-chritinerasi/Katalon Studio/Example Testing Mobile Automation/Screenshot', FailureHandling.STOP_ON_FAILURE)
